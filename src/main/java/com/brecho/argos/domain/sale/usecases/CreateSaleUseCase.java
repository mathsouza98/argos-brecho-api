...
public class CreateSaleUseCase {
    ...
    public Sale createSale(Sale sale) {
        ...
        for (SaleItem saleItem : saleItems) {
            String saleItemKey = saleItem.getProduct().getId();

            if (availableInventoryItems.containsKey(saleItemKey)) {
                InventoryItem inventoryItem = availableInventoryItems.get(saleItemKey);
